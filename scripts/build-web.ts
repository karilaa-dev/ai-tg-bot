...
const result = await Bun.build({
  entrypoints: ["src/web/client/app.tsx"],
  outdir: output,
  target: "browser",
  minify: true,
  naming: "app.[ext]",
...
<html lang="en" class="light"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="color-scheme" content="light"><title>Conversations · Telegram bot</title><link rel="stylesheet" href="/style.css"></head><body><div id="root"></div><script type="module" src="/app.js"></script></body></html>`);
