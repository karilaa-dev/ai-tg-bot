...
The default tag comes from the application version in `package.json`. Version `2.0.9` uses `ai-tg-bot-tools:v2.0.9`. Put the normal application secrets, including `E2B_API_KEY`, in the ignored root `.env`.
