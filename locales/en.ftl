...
thinking-done = ✅ Done.
thinking-summary = 🧠 Thinking ({ $steps } steps)
show-more = 📖 Show more
...
file-processing-downloading = 📥 Downloading { $name }...
file-processing-extracting = 📄 Extracting { $name }...
file-processing-captioning = 🖼️ Captioning { $name }...
file-processing-indexing = 🔎 Indexing { $name }... { $percent }%
...
file-processed = ✅ File #{ $id } processed.
file-reused = ♻️ Reused cached file #{ $id }.
